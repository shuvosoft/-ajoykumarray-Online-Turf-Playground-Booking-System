                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ url('/post_image/' . $post->image) }}" alt="Profile Image"></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ url('/post_image/' . $randompost->image) }}" alt="{{ $randompost->title }}"></div>
...
{{--                                            <a class="avatar" href="#"><img src="{{ Storage::disk('public')->url('profile/'.$comment->user->image) }}" alt="Profile Image"></a>--}}
                                            <a class="avatar" href="#"><img src="{{ url('/profile/' . $comment->user->image) }}" alt="Profile Image"></a>
                                        </div>
