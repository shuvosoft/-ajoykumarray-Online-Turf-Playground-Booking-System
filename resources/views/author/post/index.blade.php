...
{{--                                            <td> {!! html_entity_decode(str_limit($post->body,'10')) !!}</td>--}}
                                            <td>
                                                @if($post->b_status == 0)
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deletePost({{ $post->booking_id }})" title="cancel booking">
                                                    <i class="material-icons">delete </i>
                                                </button>
                                                <form id="delete-form-{{ $post->booking_id }}" action="{{ route('author.booking.destroy',$post->booking_id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                               @endif
